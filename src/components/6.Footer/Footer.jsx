...
function Footer () {
    ...
    return(
      ...
      <div className="item3">
        <form>
          <h4>Subscribe now</h4>
          <input className="item3-input" type="text" placeholder="Your e-mail"></input>
          <br></br>
